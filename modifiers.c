...
/**
 * print_width - Stores leading spaces to a buffer to a width modifier.
 *
 ...
 *
 * @output: A buffer_t struct containing a characterarray.
 * @printed: THe current number of bytes already stored to output
 * for a given specifier.
 * @flags: Flag modifiers.
 * @wid: A width modifier.
 *
 * Return: The number od bytes stored to the buffer.
 */
