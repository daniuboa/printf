...
unsigned int convert_r(va_list args, buffer_t *output,
		unsigned char flags, int wid, int prec, unsigned char len);
unsigned int convert_R(va_list args, int buffer_t *output,
		unsigned char flags, int wid, int prec, unsigned char len);

/**
 * convert_s - Convert an argument to a string and
 * stores it to a buffer contained in a stuct.
 *
...
/**
 * convert_r - Reverse a string and stores it
